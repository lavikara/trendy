const templates = {
  textTemplate: `<div id="textElement" draggable="true" class="tw-absolute tw-top-[20px] tw-left-[20px] tw-cursor-move">
                  <div id="headerText" class="tw-relative tw-h-[40px]">
                    <p contentEditable="false" class="tw-h-[40px] tw-text-white tw-text-lg xs:tw-text-2xl tw-font-bold tw-text-center">
                      Edit text here
                    </p>
                  </div>
                </div>`,
  imageTemplate: `<div draggable="true" class="tw-absolute tw-top-[60px] tw-left-20px tw-h-[55px] tw-w-[200px] tw-cursor-move">
                    <img id="image"/>                 
                  </div>`,
